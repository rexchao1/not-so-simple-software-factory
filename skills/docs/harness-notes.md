...
Verified facts about agent harnesses (claude, codex, opencode, pi, grok, kimi, cursor, muse) as recorded in firstmate at commit 1cb900c on 2026-08-19.
Kept as a reference; the firstmate-specific parts (crewmate, secondmate, captain, config/crew-*) describe that project and not this one.
Re-verify any fact before relying on it, since harness behaviour changes with each release.

Source: https://github.com/kunchenguid/firstmate (MIT, Copyright 2026 Kun Chen). See NOTICE.md.
